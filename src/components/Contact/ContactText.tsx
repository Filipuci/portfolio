...
const CONTACT_LINKS = [
  { label: 'GitHub', href: 'https://github.com/Filipuci' },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/rafael-filipuci/' },
  { label: 'E-mail', href: 'mailto:rafaellifipuci@outlook.com' },
] as const
